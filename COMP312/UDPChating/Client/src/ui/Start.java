...
public class Start {
    ...
    private void setPInitial(){
		...
		JLabel lPort = new JLabel("Other side port:");
		...
		gbc_tPort.insets = new Insets(0, 0, 5, 5);
		gbc_tPort.fill = GridBagConstraints.HORIZONTAL;
		gbc_tPort.gridx = 6;
		gbc_tPort.gridy = 7;
		if(!isServer) pInitial.add(tPort, gbc_tPort);
		tPort.setColumns(10);
		...
		JLabel lYourPort = new JLabel("Your port number is: " + localPort);
    			...
    			new ActionListener(){
    				public void actionPerformed(ActionEvent e){
    					...
    					if(isServer){
    						...
    						system.connectToP2P(tIP.getText(), tPort.getText());
